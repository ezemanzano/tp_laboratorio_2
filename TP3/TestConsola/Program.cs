...
namespace TestConsola
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                Auto car1 = new Auto("Clio", "Negro", 1200, Automoviles.Tipo.Auto, Automoviles.TipoModelo.Base, Automoviles.Motor.Nafta, 3);
                agregar = fabric + car1;
            ...
            {
                Auto car2 = new Auto("Prius", "Azul", 1800, Automoviles.Tipo.Auto, Automoviles.TipoModelo.Full, Automoviles.Motor.Electrico, 5);
                agregar = fabric + car2;
